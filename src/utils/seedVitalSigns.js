...
const vitalSignsAlerts = [
  ...
  { id: 'ALT005', patientId: 'P004', type: 'Temperature', message: 'Fever alert: 100.2°F', severity: 'Medium', date: '2024-05-16', resolved: true },
  ...
  { id: 'ALT008', patientId: 'P005', type: 'Temperature', message: 'Slight temperature elevation (99.0°F)', severity: 'Low', date: '2024-06-29', resolved: true },
];
...
export const seedVitalSigns = async () => {
  ...
  try {
    ...
    console.log(`⚠️ Added ${vitalSignsAlerts.length} vital sign alerts`);
